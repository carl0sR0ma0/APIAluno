...
namespace APIAluno.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dt_Birth")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Dt_Birth")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
